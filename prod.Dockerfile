...
# Added git for dependencies that need git init
# Added openssh-client for GitHub dependencies using SSH
RUN apk add --no-cache python3 make g++ git openssh-client git openssh-client zlib-dev brotli-dev c-ares-dev nghttp2-dev openssl-dev icu-dev ada-dev simdjson-dev simdutf-dev sqlite-dev zstd-dev
